...
public class ProfilUserFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        nama_admin = view.findViewById(R.id.namalk_p);
        namaPengguna_admin = view.findViewById(R.id.nama_p_P);
        alamat_admin = view.findViewById(R.id.alamat_p);
        tlp_admin = view.findViewById(R.id.telp_p);
        ttl_admin = view.findViewById(R.id.ttl_p);
        email_admin = view.findViewById(R.id.email_p);
